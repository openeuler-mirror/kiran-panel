...
const char*
_mate_panel_applet_frame_get_iid (MatePanelAppletFrame           *frame)
{
...
int
mate_panel_applet_frame_activating_get_tries (MatePanelAppletFrameActivating *frame_act)
{
	return frame_act->tries;
}

void
mate_panel_applet_frame_activating_set_tries   (MatePanelAppletFrameActivating *frame_act, int tries)
{
	frame_act->tries = tries;
}
