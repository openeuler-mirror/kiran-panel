...
panel_menu_items_append_lock_logout (GtkWidget *menu)
{
	...
	char       *label;
	char       *tooltip;
	panel_menu_items_append_from_desktop (menu,"matecc.desktop",NULL,TRUE);  /*Kylin add control center to the main menu  Kylin*/
	panel_menu_items_append_from_desktop (menu,"mate-search-tool.desktop",NULL,TRUE);  /*Kylin add search tool to the main menu  Kylin*/
