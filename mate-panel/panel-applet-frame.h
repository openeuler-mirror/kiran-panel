...
int            mate_panel_applet_frame_activating_get_tries   (MatePanelAppletFrameActivating *frame_act);
void           mate_panel_applet_frame_activating_set_tries   (MatePanelAppletFrameActivating *frame_act, int tries);

void  _mate_panel_applet_frame_set_iid               (MatePanelAppletFrame           *frame,
						 const gchar                *iid);
const char* _mate_panel_applet_frame_get_iid         (MatePanelAppletFrame           *frame);
