...
G_BEGIN_DECLS
G_GNUC_INTERNAL
void _clock_marshal_POINTER__VOID (GClosure     *closure,
                                   GValue       *return_value,
...
G_BEGIN_DECLS
G_GNUC_INTERNAL
void _clock_marshal_VOID__OBJECT_STRING (GClosure     *closure,
                                         GValue       *return_value,
                                         guint         n_param_values,
                                         const GValue *param_values,
                                         gpointer      invocation_hint,
...
G_BEGIN_DECLS
G_GNUC_INTERNAL
void _clock_marshal_INT__VOID (GClosure     *closure,
                               GValue       *return_value,
                               guint         n_param_values,
                               const GValue *param_values,
                               gpointer      invocation_hint,
